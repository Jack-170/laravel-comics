...
View::composer('components.main', function ($view) {
    $comics = [
        [
            ...
            "thumb" => "https://imgix.bustle.com/inverse/72/aa/b9/e4/88e9/4fea/8cb6/de1edceadc95/cover-of-action-comics-1000-by-jim-lee.jpeg?w=2000&auto=format&q=70&fit=max&crop=faces",
            "price" => "$19.99",
